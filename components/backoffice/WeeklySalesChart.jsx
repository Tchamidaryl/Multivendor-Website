                  ...
                  <button
                    ...
                    className={
                      chartToDisplay == tab.type
                        ...
                        : "inline-block p-4 border-b-2 border-transparent rounded-t-lg text-slate-800 hover:border-gray-900 hover:text-gray-700 dark:hover:border-gray-100 dark:text-gray-100"
                    }
                  >
                    {tab.title}
                  </button>
