    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="flex gap-4 items-center">
        <Link
          ...
          className="shrink-0 font-medium text-lime-600 hover:underline dark:text-lime-500"
        >
          Forgot Password
        </Link>
        {loading ? (
          <button
            disabled
            type="button"
            className="w-full text-white bg-lime-700 hover:bg-lime-800 focus:ring-4 focus:outline-none focus:ring-lime-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800 inline-flex items-center"
          >
            <svg
              aria-hidden="true"
              role="status"
